...
PER_FOLD_FILES = {
    "Morgan":  Path("TRPV1_IC50_5x5cv_stats/IC50_Morgan_rand_per_fold_metrics_5x5.csv"),
    "RDKit":   Path("TRPV1_IC50_5x5cv_stats/IC50_RDKITfp_rand_per_fold_metrics_5x5.csv"),
    "MACCS":   Path("TRPV1_IC50_5x5cv_stats/IC50_MACCS_rand_per_fold_metrics_5x5.csv"),
    "Mordred": Path("TRPV1_IC50_5x5cv_stats/IC50_Mordred_scaffCV_per_fold_metrics_5x5.csv"),
}
...
OUT_PNG = STATS_DIR / "IC50_S2_MCC_GMean_boxplots_5x5CV.png"
OUT_PDF = STATS_DIR / "IC50_S2_MCC_GMean_boxplots_5x5CV.pdf"
...
if not all_rows:
    raise RuntimeError("No per-fold IC50 CV files loaded – check PER_FOLD_FILES paths.")
