...
ic50_files = {
    "Morgan":  data_dir / "IC50_Morgan_rand_per_fold_metrics_5x5.csv",
    "RDKit":   data_dir / "IC50_RDKITfp_rand_per_fold_metrics_5x5.csv",
    "MACCS":   data_dir / "IC50_MACCS_rand_per_fold_metrics_5x5.csv",
    "Mordred": data_dir / "IC50_Mordred_scaffCV_per_fold_metrics_5x5.csv",
}

mean_tables = []

for desc, filepath in ic50_files.items():
...
ic50_master = pd.concat(mean_tables, ignore_index=True)
...
ic50_master = ic50_master[col_order]

# Save to CSV for Table 1
out_path = data_dir / "IC50_master_mean_scores.csv"
ic50_master.to_csv(out_path, index=False)

print(f"Saved IC50 master table to: {out_path}")
print(ic50_master.head())
