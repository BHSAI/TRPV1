...
OUT_FOLDERS = {
    "RDKITfp": "TRPV1_EC50_RDKITfp",
    "MACCS":   "TRPV1_EC50_MACCS",
    "Morgan":  "TRPV1_EC50_Morgan",
}
...
def save_summary_tables(per_fold_df: pd.DataFrame, fp_name: str, out_dir: Path):
    ...
    # per-fold CSV
    per_fold_csv = out_dir / f"EC50_{fp_name}_rand_per_fold_metrics_5x5.csv"
    ...
    avg_csv = out_dir / f"EC50_{fp_name}_rand_avg_metrics_5x5.csv"
    ...
    sd_csv = out_dir / f"EC50_{fp_name}_rand_avg+sd_metrics_5x5.csv"
