...
#!/usr/bin/env python
"""
08_TRPV1_EC50_MorganLR_SHAP_external.py
...
OUT_DIR   = Path("TRPV1_EC50_shap_Morgan")
OUT_DIR.mkdir(parents=True, exist_ok=True)

MODEL_PKL = OUT_DIR / "EC50_Morgan_LR_fulltrain.pkl"
...
def main():
    ...
    out_summary = OUT_DIR / "EC50_MorganLR_SHAP_summary_external.png"
    ...
    out_bar = OUT_DIR / "EC50_MorganLR_SHAP_bar_external.png"
