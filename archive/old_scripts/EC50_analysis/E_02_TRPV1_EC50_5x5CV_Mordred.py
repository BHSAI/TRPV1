...
#!/usr/bin/env python
"""
Mordred descriptor pipeline on TRPV1 EC50 (train scaffold split):
...
OUT_DIR   = Path("TRPV1_EC50_scaff_Mordred")
...
def main():
    ...
    per_fold_csv = OUT_DIR / "EC50_Mordred_scaffCV_per_fold_metrics_5x5.csv"
    ...
    avg_csv = OUT_DIR / "EC50_Mordred_scaffCV_avg_metrics_5x5.csv"
    ...
    sd_csv = OUT_DIR / "EC50_Mordred_scaffCV_avg+sd_metrics_5x5.csv"
