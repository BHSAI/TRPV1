...
#!/usr/bin/env python
"""
07_TRPV1_EC50_external_bars_MorganLR.py

Create a publication-ready bar plot of external scaffold-test
performance for the Morgan + LogisticRegression model (EC50).
...
# ---------- CONFIG ----------
STATS_CSV = Path("TRPV1_EC50_champions_external_metrics.csv")

OUT_PNG = Path("TRPV1_EC50_external_MorganLR_bars.png")
OUT_PDF = Path("TRPV1_EC50_external_MorganLR_bars.pdf")
