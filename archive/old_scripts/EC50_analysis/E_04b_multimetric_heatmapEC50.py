...
# Reload data
ec50 = pd.read_csv('TRPV1_EC50_5x5cv_stats/EC50_master_mean_scores.csv')
...
def grouped_minmax_heatmap(
    ...
    fig.subplots_adjust(left=0.23)   # tweak 0.2–0.28 as needed
    ...
    # --- save as 300 dpi image if requested ---
...
grouped_minmax_heatmap(ec50, metrics, descriptor_order, model_order, save_path="TRPV1_EC50_multimetric_heatmap.png")
